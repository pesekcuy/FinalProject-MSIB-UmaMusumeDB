...
public class AuthController {
    ...
    public AuthController(UmaService umaService) {
    ...
    public String registration(@Valid @ModelAttribute("user") UserDto userDto,
                               ...
                               Model model){
        User existingUser = umaService.findUserByEmail(userDto.getEmail());
    ...
    public String users(Model model){
        List<UserDto> users = umaService.findAllUsers();
